...
export const MistralLogo = ({
  ...
  return (
    <svg
      ...
      className={className}
    >
      <path d="M4 6.5C4 4.567 5.567 3 7.5 3h17c1.933 0 3.5 1.567 3.5 3.5v17c0 1.933-1.567 3.5-3.5 3.5h-7.023c-.83 0-1.5-.672-1.5-1.5 0-.828.67-1.5 1.5-1.5H24.5c.276 0 .5-.224.5-.5v-17c0-.276-.224-.5-.5-.5h-17c-.276 0-.5.224-.5.5v17c0 .276.224.5.5.5h3.161c.83 0 1.5.672 1.5 1.5 0 .828-.67 1.5-1.5 1.5H7.5C5.567 27 4 25.433 4 23.5v-17Zm5.945 4.086c.375-.72 1.11-1.173 1.912-1.173.807 0 1.546.459 1.918 1.186l2.22 4.323 2.224-4.332a2.162 2.162 0 0 1 1.926-1.177c.807 0 1.543.458 1.915 1.182l3.83 7.457a1.5 1.5 0 0 1-2.662 1.374l-3.289-6.406-2.238 4.366a2.162 2.162 0 0 1-1.926 1.177c-.807 0-1.543-.458-1.916-1.182l-2.225-4.328-3.283 6.4a1.5 1.5 0 1 1-2.662-1.368l3.976-7.526Z" />
    </svg>
  );
};
